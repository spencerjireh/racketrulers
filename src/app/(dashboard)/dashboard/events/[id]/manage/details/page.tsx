...
export default function DetailsPage({
  ...
  return (
    <div className="space-y-8">
      <Card>
        ...
        <CardContent>
          <EventSettingsForm
            event={{
              ...event,
              scoringConfig: event.scoringConfig as
                | {
                    pointsPerSet: number;
                    totalSets: number;
                ...
                | undefined,
              scheduleConfig: event.scheduleConfig as
                | {
                    slotDuration: number;
                    dayStartHour: number;
                    dayEndHour: number;
      ...
      <LocationsManager eventId={id} />

      {/* Status & Danger Zone - only for published/completed events */}
      {!isDraft && (
        <Card>
          <CardHeader>
