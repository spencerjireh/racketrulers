...
export function LocationsManager({ tournamentId }: { tournamentId: string }) {
  const trpc = useTRPC();
    ...
    trpc.locations.create.mutationOptions({
      onSuccess: () => {
        queryClient.invalidateQueries(
          trpc.locations.list.queryFilter({ tournamentId })
        );
        setNewName("");
  ...
  function handleAdd(e: React.FormEvent) {
    ...
    createLocation.mutate({ tournamentId, name: newName.trim() });
  }
  ...
  function handleSaveEdit(id: string) {
    ...
    updateLocation.mutate({ id, tournamentId, name: editName.trim() });
  }
                  ...
                  <TableCell>
                    <Button
                      ...
                      onClick={() => {
                        ...
                        deleteLocation.mutate({ id: location.id, tournamentId });
                      }}
